      ...
      <div class="flex items-center justify-between px-4 py-2 bg-gray-50 border-b">
        ...
        <div class="flex gap-1">
          ...
          <button
            ...
            class="px-3 py-1 text-xs bg-red-500 text-white rounded hover:bg-red-600 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-1 focus:outline-none"
          >
            🗑️
          </button>
        </div>
